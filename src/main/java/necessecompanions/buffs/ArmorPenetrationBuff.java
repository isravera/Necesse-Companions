...
public class ArmorPenetrationBuff extends VicinityBuff {
    public ArmorPenetrationBuff() {
    ...
    public void init(ActiveBuff activeBuff, BuffEventSubscriber subscriber) {
        activeBuff.setModifier(BuffModifiers.ARMOR_PEN_FLAT, 8);
        activeBuff.setModifier(BuffModifiers.SPEED, 0.2F);
    }

    @Override
    public void updateLocalDisplayName() {
        System.out.println(this.getStringID());
